...
trait MemcacheDriverCollisionDetectorTrait
{
    ...
    public static function checkCollision($driverName)
    {
        ...
        if($driverName && is_string($driverName))
        {
            ...
            {
                trigger_error('Memcache collision detected, you used both Memcache and Memcached driver in your script, this may leads to unexpected behaviours', E_USER_WARNING);
                return false;
            }
            return true;
        }
