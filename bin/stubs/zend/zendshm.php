 ...
 * @return bool
 */
function zend_shm_cache_store(string $key, mixed $value , int $ttl = 0): bool {return true;}
 ...
 * @return bool
 */
function zend_shm_cache_add(string $key, mixed $value , int $ttl = 0): bool {return true;}
 ...
 * @return mixed
 */
function zend_shm_cache_fetch(mixed $key, ?callable $callback = null): mixed {return null;}
 ...
 * @return bool
 */
function zend_shm_cache_delete(mixed $key, ?bool $clusterDelete = true): bool{return true;}
 ...
 * @return bool
 */
function zend_shm_cache_clear(?string $namespace = null, ?bool $clusterDelete = true): bool{return true;}
 ...
 * @return array|false
 */
function zend_shm_cache_info(): array|false{return [];}
